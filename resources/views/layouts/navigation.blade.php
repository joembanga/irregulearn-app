        ...
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex md:items-center md:space-x-6 flex-1 justify-center">
                <div class="flex items-center space-x-4">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" wire:navigate>Dashboard
                    </x-nav-link>
                    <x-nav-link :href="route('learn.index')" :active="request()->routeIs('learn.index')" wire:navigate>Apprendre</x-nav-link>
                    <x-nav-link :href="route('leaderboard')" :active="request()->routeIs('leaderboard')" wire:navigate>Classement
                    </x-nav-link>
                    <x-nav-link :href="route('verbs.index')" :active="request()->routeIs('verbs.index')" wire:navigate>Verbes</x-nav-link>
                    <x-nav-link :href="route('shop')" :active="request()->routeIs('shop')" wire:navigate>Boutique</x-nav-link>
                </div>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <button @click="toggleTheme" class="w-full flex items-center gap-3 px-4 py-2 text-sm justify-between transition" >
                            <span x-text="isDark ? 'Sombre' : 'Clair'"></span>
            ...
            <div class="flex flex-row items-center justify-betwen md:hidden gap-1.5">
                ...
                <livewire:notification-icon />
                <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center gap-0 p-1 text-muted"
                    aria-label="Série actuelle">
