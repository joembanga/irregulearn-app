    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-8 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 to-violet-600 p-8 text-white shadow-xl">
                    <div class="relative z-10">
                        <div class="flex items-start justify-between">
                            <div>
                                <h3 class="text-3xl font-black mb-2">Défi Quotidien</h3>
                                <p class="text-indigo-100 mb-6 max-w-md">
                                    Tes verbes du jour t'attendent. Maîtrise-les pour garder ta série en vie !
                                </p>
                            </div>
                            <div class="hidden sm:block text-5xl bg-white/10 p-4 rounded-2xl backdrop-blur-sm">
                                📅
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-4 items-center mt-4">
                            <a href="{{ route('learn.daily') }}"
                                class="group flex items-center gap-3 px-8 py-4 bg-white text-indigo-600 rounded-2xl font-black text-lg transition hover:scale-105 active:scale-95 shadow-lg shadow-indigo-900/20">
