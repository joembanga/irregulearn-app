...
<div class="space-y-6">
    <div class="text-left">
        <h2 class="text-2xl font-bold text-gray-900 ">{{ __('Créer un compte') }}</h2>
        <p class="mt-2 text-sm text-gray-500 font-medium">{{ __('Rejoins IrreguLearn et commence à maîtriser les verbes.') }}</p>
    </div>
    ...
    <p class="text-sm font-medium text-gray-500">
        {{ __('Déjà inscrit ?') }}
        <a href="{{ route('login') }}" wire:navigate class="font-bold text-primary hover:underline transition-all">
            {{ __('Se connecter') }}
        </a>
    </p>
</div>
