<x-app-layout>
    <div class="py-6 lg:py-12 bg-app min-h-screen">
            ...
            <div
                ...
                <div class="flex flex-col md:flex-row items-center gap-8 relative z-10">
                    <div class="relative group">
                        ...
                        @else
                        <div
                            class="relative w-32 h-32 rounded-full bg-primary/10 flex items-center justify-center text-primary font-black text-5xl border-4 border-surface shadow-2xl">
                    ...
                    <div class="text-center md:text-left">
                        <h2 class="text-3xl font-black text-body uppercase tracking-tight">{{ $user->firstname }}
                            {{ $user->lastname }}
                        </h2>
            ...
            <div id="avatar-section" class="scroll-mt-24" x-data
                ...
                <div class="card-surface rounded-[2.5rem] p-8 md:p-12 shadow-xl border border-muted">
                    <div class="mb-10 text-center">
                        <h3 class="text-2xl font-black text-body uppercase tracking-tighter italic">Personnalisation du
                            Héros</h3>
